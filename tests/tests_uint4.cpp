...
bool test107_funcv_uint4()
{
  const uint4 Cx1( uint(1),  uint(2),  uint(4294967293),  uint(4));
  const uint4 Cx2( uint(5),  uint(4294967291),  uint(6),  uint(4));
  const uint4 Cx9( uint(2),  uint(2),  uint(2),  uint(2));
  const uint4 Cx0( uint(0),  uint(0),  uint(0),  uint(0));
...
bool test111_any_all_uint4() // dummy test
{
  ...
  uint4 cmp1 = uint4(Cx1 < Cx3);
  uint4 cmp2 = uint4(Cx1 < Cx2);
  uint4 cmp3 = uint4(Cx1 <= Cx2);
  uint4 cmp4 = uint4(Cx1 > Cx3);
